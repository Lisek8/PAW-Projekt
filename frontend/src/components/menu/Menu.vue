<template>
  ...
  <router-link to="/" class="navbar-brand">
    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-kanban-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <ul class="navbar-nav ml-md-auto">
      ...
      <template v-else>
        <form class="form-inline">
          <li class="nav-item">
            <button @click="openBoardCreationModal" class="btn btn-secondary my-2 my-sm-0" data-toggle="modal" data-target="#exampleModal">
          ...
          <li class="nav-item">
            <router-link to="/boards" class="btn btn-secondary my-2 my-sm-0 ml-2">
          ...
          <li class="nav-item">
            <router-link to="/" class="btn btn-secondary my-2 my-sm-0 ml-2">
          ...
          <li class="nav-item">
            <button @click="logout" class="btn btn-danger my-2 my-sm-0 ml-2">Wyloguj się</button>
          </li>
        </form>
      </template>
  </ul>
